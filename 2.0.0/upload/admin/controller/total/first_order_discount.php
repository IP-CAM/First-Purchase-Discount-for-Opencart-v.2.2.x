<?php
class ControllerTotalFirstOrderDiscount extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('total/first_order_discount');
		...
		if (isset($this->error['discount_amount'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('total/first_order_discount', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);

		$data['action'] = $this->url->link('total/first_order_discount', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['token'] = $this->session->data['token'];
				...
				$this->response->setOutput($this->load->view('total/first_order_discount', $data));
	}

	private function validate() {

		if (!$this->user->hasPermission('modify', 'total/first_order_discount')) {
